...
CREATE TABLE `announcement`  (
                                 ...
                                 `send_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '发送方式(JSON数组): system=系统通知(指定用户走message表), website=公告(全部用户走announcement表), email=邮件; 可多选如[\"system\",\"email\"]',
                                 `target_type` tinyint NOT NULL DEFAULT 1 COMMENT '发送对象：1-全部用户 2-指定用户',
                                 `target_users` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '发送对象id(JSON数组)',
...
INSERT INTO `link` VALUES (27, 1, '百度', 'https://baidu.com', 'https://www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png', '这个网站是搜索引擎', 0, 'contact@qq.com', '2025-11-09 16:24:05', 0);
...
INSERT INTO `sys_menu` VALUES (27, 26, '公告管理', 0, '/notification/announcement', '/notification/announcement', 'Bell', 0, '2026-03-30 00:00:00', '2026-03-30 00:00:00', 0);
...
INSERT INTO `sys_permission` VALUES (96, '获取公告列表', 'announcement:list', 27, '2026-03-30 00:00:00', '2026-03-30 00:00:00', 0);
INSERT INTO `sys_permission` VALUES (97, '创建公告', 'announcement:create', 27, '2026-03-30 00:00:00', '2026-03-30 00:00:00', 0);
INSERT INTO `sys_permission` VALUES (98, '取消公告', 'announcement:cancel', 27, '2026-03-30 00:00:00', '2026-03-30 00:00:00', 0);
INSERT INTO `sys_permission` VALUES (99, '删除公告', 'announcement:delete', 27, '2026-03-30 00:00:00', '2026-03-30 00:00:00', 0);
INSERT INTO `sys_permission` VALUES (100, '获取通知列表', 'message:list', 28, '2026-03-30 00:00:00', '2026-03-30 00:00:00', 0);
INSERT INTO `sys_permission` VALUES (101, '更新友链', 'link:update', 19, '2026-04-01 00:51:20', '2026-04-01 00:51:20', 0);
...
INSERT INTO `sys_role_menu` VALUES (67, 2, 21);
INSERT INTO `sys_role_menu` VALUES (68, 1, 26);
INSERT INTO `sys_role_menu` VALUES (69, 1, 27);
INSERT INTO `sys_role_menu` VALUES (70, 1, 28);
INSERT INTO `sys_role_menu` VALUES (71, 2, 26);
INSERT INTO `sys_role_menu` VALUES (72, 2, 27);
INSERT INTO `sys_role_menu` VALUES (73, 2, 28);
...
INSERT INTO `sys_role_permission` VALUES (161, 2, 93);
INSERT INTO `sys_role_permission` VALUES (162, 2, 94);
INSERT INTO `sys_role_permission` VALUES (163, 1, 95);
INSERT INTO `sys_role_permission` VALUES (164, 1, 96);
INSERT INTO `sys_role_permission` VALUES (165, 1, 97);
INSERT INTO `sys_role_permission` VALUES (166, 1, 98);
INSERT INTO `sys_role_permission` VALUES (167, 1, 99);
INSERT INTO `sys_role_permission` VALUES (168, 1, 100);
INSERT INTO `sys_role_permission` VALUES (169, 2, 96);
INSERT INTO `sys_role_permission` VALUES (171, 1, 101);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'sidifensen', '$2a$10$8qg1JmLqfH0U/pBpxg7Ptuo7k16eDoDTlXDXni3FRAjSRgBtj7rsG', '斯蒂芬森', 'sidifensen@qq.com', 0, NULL, '', 0, 5, 35, 0, '127.0.0.1', '内网地址', 0, '127.0.0.1', '内网地址', '2026-03-31 01:01:37', '2025-06-28 22:30:22', '2025-10-09 16:14:20', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'VIP会员表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of vip_member
-- ----------------------------
INSERT INTO `vip_member` VALUES (1, 1, 'ACTIVE', '2026-03-22 01:05:26', '2027-06-04 23:59:49', 'VIP1774112517813B19C649B', '2026-03-11 23:59:49', '2026-03-11 23:59:49', 0);
...
-- Records of vip_plan
-- ----------------------------
INSERT INTO `vip_plan` VALUES (1, 'VIP_MONTH', '月卡会员', 30, 990, 1, '30天 VIP 内容与 AI 提额', '2026-03-12 23:10:04', '2026-03-12 23:10:04', 0);
INSERT INTO `vip_plan` VALUES (2, 'VIP_QUARTER', '季卡会员', 90, 2590, 1, '90天 VIP 内容与 AI 提额', '2026-03-12 23:10:04', '2026-03-12 23:10:04', 0);
INSERT INTO `vip_plan` VALUES (3, 'VIP_YEAR', '年卡会员', 365, 8800, 1, '365天 VIP 内容与 AI 提额', '2026-03-12 23:10:04', '2026-03-12 23:10:04', 0);
